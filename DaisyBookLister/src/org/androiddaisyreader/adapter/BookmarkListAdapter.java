...
public class BookmarkListAdapter extends ArrayAdapter<Bookmark> {
    ...
    private List<Bookmark> mListBookmark;
    ...
    public BookmarkListAdapter(Context context, List<Bookmark> listBookmark,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        RadioButton mRbt = (RadioButton) mV.findViewById(R.id.itemBookmark);
     ...
     * @param time
     */
    private void pushToDaisyEbookReaderVisualModeIntent(String audioFileName, String path,
