...
public class DaisyBookHelperTest extends AndroidTestCase {
    ...
    public void testDaisyBookReturnTrueWhenTypeIsCorrect() {
        // exercise
        List<DaisyBookInfo> daisyInfoList = getAllDaisyBook(Constants.TYPE_DOWNLOAD_BOOK);
    ...
    public List<DaisyBookInfo> getAllDaisyBook(String type) {
        ...
        List<DaisyBookInfo> arrDaisyBook = helper.getAllDaisyBook(type);
        return arrDaisyBook;
    }
    ...
    public void testDeleteDaisyBookReturnTrueWhenTypeIsCorrect() {
        ...
        assertTrue(result);
        List<DaisyBookInfo> arrDaisyBook = helper
    ...
    public void testGetDaisyBookByTitle() {
        addDaisyBookValidToDatabase(Constants.TYPE_DOWNLOAD_BOOK);
        DaisyBookInfo daisyBook = helper.getDaisyBookByTitle(TITLE_DAISY_BOOK,
                Constants.TYPE_DOWNLOAD_BOOK);
