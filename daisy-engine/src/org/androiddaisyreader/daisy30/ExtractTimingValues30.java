 ...
 * @author Julian Harty
 */
public class ExtractTimingValues30 {
	...
	static double extractTiming(String elementName, Attributes attributes) {
		double trimmedValue = getTrimmedValue(elementName, attributes);
		return trimmedValue;
	}

	private static double getTrimmedValue(String elementName, Attributes attributes) {
		...
		double trimmedValue = parseToMiliseconds(splitRawValue[0], splitRawValue[1],
				splitRawValue[2]);
		return trimmedValue;
	}
