...
public class ParserUtilities {
	...
	/**
	 * Return the value for a given name if the name is matched.
	 ...
	 * instead. This implementation is basic and tries the first, and only
	 * calls the second if the first returns a null or empty string.
	 * @param nameToMatch
	 * @param attributes
